...
class Options_Machine {
	...
	public static function optionsframework_slider_function($id,$std,$oldorder,$order){
		...
		//initialize all vars
		$slidevars = array('title','url','description', 'title_animation', 'desc_animation');
		...
		$slider .= '<label>Title Animation</label>';
		$slider .= '<input name="'. $id .'['.$order.'][title_animation]" value="'. stripslashes($val['title_animation']) .'" />';

		$slider .= '<label>Description Animation</label>';
		$slider .= '<input name="'. $id .'['.$order.'][desc_animation]" value="'. stripslashes($val['desc_animation']) .'" />';
